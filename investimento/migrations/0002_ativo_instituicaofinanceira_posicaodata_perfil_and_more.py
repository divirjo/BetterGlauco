    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "desdobramento",
                    models.DecimalField(decimal_places=10, default=0, max_digits=15),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cota_ativo_quantidade",
                    models.DecimalField(decimal_places=10, default=0, max_digits=15),
                ),
                (
                    "cota_sistema_quantidade",
                    models.DecimalField(decimal_places=10, default=0, max_digits=15),
                ),
                (
                    "cota_sistema_valor_currency",
                    djmoney.models.fields.CurrencyField(
                        choices=[
                            ("XUA", "ADB Unit of Account"),
                            ("AFN", "Afghan Afghani"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operacao",
                    models.CharField(
                        choices=[("VENDA", "Venda"), ("COMPRA", "Compra")],
                        max_length=10,
                    ),
                ),
                (
                    "valor_unitario_currency",
                    djmoney.models.fields.CurrencyField(
                        choices=[
                            ("XUA", "ADB Unit of Account"),
                            ("AFN", "Afghan Afghani"),
