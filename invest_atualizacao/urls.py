...
from .views import (
    ...
    DividendosInicio,
    InicioAtualizacao,
    PosicaoIndividualBolsa,
    PosicaoIndividualBolsaEditar,
    PosicaoIndividualBolsaNova,
    PosicaoIndividualFundo,
    PosicaoIndividualFundoEditar,
    PosicaoIndividualFundoNova,
)

app_name = 'invest_atualizacao'

urlpatterns = [
    path('', InicioAtualizacao.as_view(), name='inicio_atualizacao'),
    path('dividendos/', DividendosInicio.as_view(), name='dividendos'),
    path('dividendos/novo/', DividendoNovo.as_view(), name='dividendos_novo'),
    path(
        'dividendos/editar/<int:pk>',
    ...
    path(
        'individual/bolsa/editar/<int:pk>',
    ...
    path(
        'individual/fundo/editar/<int:pk>',
